...
public partial class addchristmasspecials : System.Web.UI.Page
{
    ...
    protected void btnAddChocolate_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            String folderpath = "~/images/christmasspecials/";
            ...
            cmd.CommandText = @"insert into christmasspecials(chocolate_name,chocolate_description,chocolate_price,chocolate_imgurl) values (@chocolate_name,@chocolate_description,@chocolate_price,@chocolate_imgurl)";
            cmd.Connection = con;
