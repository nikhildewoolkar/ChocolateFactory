<%@ Page Title="" Language="C#" MasterPageFile="~/adminmaster.master" AutoEventWireup="true" CodeFile="addvalentinesspecials.aspx.cs" Inherits="addvalentinesspecials" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    
        <center><h2 style="color:maroon" class="title-w3">Add Valentines Special Chocolates</h2>               
