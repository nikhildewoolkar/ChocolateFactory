<%@ Page Title="" Language="C#" MasterPageFile="~/adminmaster.master" AutoEventWireup="true" CodeFile="adddiwalispecials.aspx.cs" Inherits="adddiwalispecials" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    
        <center><h2 style="color:maroon" class="title-w3">Add Diwali Special Chocolates</h2>               </center>
