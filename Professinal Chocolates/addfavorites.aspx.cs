...
public partial class addfavorites : System.Web.UI.Page
{
    ...
    protected void btnAddChocolate_Click(object sender, EventArgs e)
    {
    ...
    protected void btnAddChocolate_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            String folderpath = "~/images/favorites/";
            ...
            cmd.CommandText = @"insert into favorites(chocolate_name,chocolate_description,chocolate_price,chocolate_imgurl) values (@chocolate_name,@chocolate_description,@chocolate_price,@chocolate_imgurl)";
            cmd.Connection = con;
