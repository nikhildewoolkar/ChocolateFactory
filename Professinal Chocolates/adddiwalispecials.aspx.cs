...
public partial class adddiwalispecials : System.Web.UI.Page
{
    ...
    protected void btnAddChocolate_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            String folderpath = "~/images/diwalispecials/";
            ...
            cmd.CommandText = @"insert into diwalispecials(chocolate_name,chocolate_description,chocolate_price,chocolate_imgurl) values (@chocolate_name,@chocolate_description,@chocolate_price,@chocolate_imgurl)";
            cmd.Connection = con;
